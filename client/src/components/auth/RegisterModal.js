                    ...
                    <ModalBody>
                        ...
                        <Form onSubmit={this.onSubmit}>
                            <FormGroup>
                                ...
                                <Input type='name' name='name' id='name' placeholder='Name' className='mb-3' onChange={this.onChange}></Input>
                                ...
                                <Button color='dark' style={{ marginTop: '2rem' }} block>Register</Button></FormGroup></Form>
                    </ModalBody>
